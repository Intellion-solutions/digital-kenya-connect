  ...
  const testimonials = [
    {
      ...
      location: "Nairobi",
      rating: 5,
      text: "Kenya Cyber helped me get my passport so quickly! The staff was incredibly patient and guided me through every step. I was so stressed about the process, but they made it simple.",
